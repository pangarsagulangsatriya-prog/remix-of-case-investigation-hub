                                     ...
                                     <div className="flex flex-col h-full bg-white overflow-hidden animate-in fade-in duration-500">
                                        <div className="h-16 border-b border-slate-200 flex items-center justify-between px-8 bg-slate-50/30 shrink-0">
                                           <div className="flex items-center gap-3">
                                              ...
                                              <h2 className="text-xl font-black text-slate-900 uppercase tracking-tighter">Actor Intelligence Profile</h2>
                                           </div>
                                           <div className="flex items-center gap-2">
                                              <div className="h-2 w-2 bg-emerald-500 rounded-full animate-pulse" />
                                              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Active Verification</span>
                                           </div>
                                        </div>
