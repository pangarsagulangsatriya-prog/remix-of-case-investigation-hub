...
export const ReportFactPage = ({ 
  isActive, pageNumber, totalPages, version, status, factAgent 
}: any) => {
...
export const ReportActorPage = ({ 
  isActive, pageNumber, totalPages, version, status, actorAgent 
}: any) => {
...
export const ReportPeepoPage = ({ 
  isActive, pageNumber, totalPages, version, status, peepoAgent 
}: any) => {
...
export const ReportIplsPage = ({ 
  isActive, pageNumber, totalPages, version, status, iplsAgent 
}: any) => {
...
export const ReportPreventionPage = ({ 
  isActive, pageNumber, totalPages, version, status, prevAgent 
}: any) => {
